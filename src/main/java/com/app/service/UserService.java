...
public class UserService implements UserAbstract {
    ...
    private static final int MIN_AGE = 13; // adjust here if your team wants a different minimum

    @Override
    @Transactional
    public User createUser(String username, String email, String password, String description) {
        return createUser(username, email, password, description, null);
    }

    @Override
    @Transactional
    public User createUser(String username, String email, String password) {
        return createUser(username, email, password, "New user", null);
    }

    @Override
    @Transactional
    public User createUser(String username, String email, String password, java.time.LocalDate dateOfBirth) {
        return createUser(username, email, password, "New user", dateOfBirth);
    }

    private User createUser(String username, String email, String password, String description, java.time.LocalDate dateOfBirth) {
        if (dateOfBirth != null) {
