...
public class EditCommentCommand extends Command {
    ...
    public EditCommentCommand(ConsolePrinter consolePrinter, CommentAbstract commentAbstract, ConsoleReader consoleReader, PostAbstract postAbstract, UserAbstract userAbstract, CommunityAbstract communityAbstract) {
    ...
    public void execute(String[] args) {
        ...
        try {
            ...
            commentAbstract.editComment(commentId, newText, userAbstract.getLoggedInUser().getUsername());
